      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-6 flex flex-col justify-center py-12 lg:py-16 relative z-10">
        <div className="max-w-md w-full mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">Create New Password</h2>
            <p className="text-sm text-slate-500">Define a strong, secure password to update your academic credentials.</p>
          </div>
              ...
              <div className="space-y-6 py-2 text-center animate-fade-in">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] text-slate-400 italic">
                    Redirecting you to the login portal in a moment...
                  </p>
                </div>
              </div>
            ) : (
